...
public class QueryFood {
    ...
    public static void InsertFood(String tenmon, String soluong, String protein,
            String tinhbot, String lipit, String nhom) throws SQLException {
        try(Connection conn = ConnectSQL.connectsql()) {
            String query = "INSERT INTO tbl_monan(tenmon, soluong, protein, tinhbot, lipit, nhom)"
                    + " VALUES(?,?,?,?,?,?)";
            PreparedStatement ps = conn.prepareStatement(query);
    ...
    public static void main(String[] args) throws SQLException {
        ...
        InsertFood("che", "1 bat", "70", "90", "49", "1");
    }
}
